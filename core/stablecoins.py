...
TIER3_STABLECOINS = [
    ...
    StablecoinDefinition("FDUSD", "First Digital USD", "first-digital-usd", "Centralized", 3),
    ...
    StablecoinDefinition("MIM", "Magic Internet Money", "magic-internet-money", "Decentralized", 3),
